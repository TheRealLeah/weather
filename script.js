...
// Get DOM Elements (BREAKOUT ROOMS)
...
// Example of API endpoint url
//  https://api.openweathermap.org/data/2.5/weather?q=Los Angeles&appid=8109965e7254a469d08a746e8b210e1e&units=imperial
...
// Create a function that returns a cardinal direction based on the degree passed in (GIVEN)
...
const updateDom = (data) => {
  console.log(data, 'from updateDom function');
  // Current temperature
  ...
  sunrise.innerText = sunriseTs.toLocaleString('en-US', {
    hour: 'numeric',
    minute: 'numeric',
  });
  // Do the same for Sunset
  sunset.innerText = sunsetTs.toLocaleString('en-US', {
    hour: 'numeric',
    minute: 'numeric',
  });
...
// Create a function that renders the chart (GIVEN)
